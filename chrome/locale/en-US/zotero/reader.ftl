...
reader-show-paper-summary = Paper Summary
reader-paper-summary-generate = Generate summary
reader-paper-summary-regenerate = Regenerate
reader-paper-summary-loading = Generating summary…
reader-paper-summary-hint = Uses the PDF text layer. Fill in the API fields above, save, then generate; the summary is cached locally.
reader-paper-summary-api-url = API base URL
reader-paper-summary-model = Model name
reader-paper-summary-api-key = API key
reader-paper-summary-save-prefs = Save settings
reader-paper-summary-settings = API settings
reader-paper-summary-saved = Settings saved
reader-paper-summary-failed = Summary request failed.
reader-paper-summary-no-handler = Summary is not available in this reader.
